...
const DataTable = () => {
  ...
  const defaultData: any = permissions;
  ...
  const getPermissions = (page: number = 1, limit: number = 10) => {
  ...
  return (
    <>
      <Stack className="table-toolbar" justifyContent="space-between">
        ...
        <Stack spacing={12} className="float-right">
          {/* <TagPicker
            label="Status"
            data={ratingList}
            searchable={false}
      ...
      >
        ...
        <Column width={120}>
          ...
          <Cell className="link-group">
            {/* {rowData => rowData.parent_id?.permission_name} */}
            {
      ...
      <DrawerView open={showDrawer} action={action} customData={{ permissions, permissionData, actionId }} onClose={() => setShowDrawer(false)} reload={()=>reloadComponent()}/>
